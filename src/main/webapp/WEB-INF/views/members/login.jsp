	...
	<c:choose>
		<c:when test="${loginId == null}">
			<div class="container">
	            ...
	            <div class="loginBox">
		            <div class="signUpDiv"><button class="loginBtn" type="submit">Login</button></div> <!-- submit 버튼 -->
		            <div class="signUpDiv"><button class="JoinBtn" type="button">Join</button></div> <!-- 일반 버튼 -->
	            </div>
